// Code generated by 'ccgo -pkgname=python -export-defines  -export-enums  -export-externs X -export-structs S -export-fields  -export-typedefs  -trace-translation-units -o internal/python/python_linux_arm.go -I ./internal/lib -I upstream/tree-sitter/lib/include upstream/tree-sitter-python/src/parser.c internal/python/patch/scanner.c', DO NOT EDIT.
