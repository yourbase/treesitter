// Code generated by 'ccgo -pkgname=lib -export-defines "" -export-enums "" -export-externs X -export-structs S -export-fields "" -export-typedefs "" -trace-translation-units -o internal/lib/treesitter_linux_amd64.go -I /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src -I /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/include /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/get_changed_ranges.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/language.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/lexer.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/lib.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/node.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/parser.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/query.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/stack.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/subtree.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/tree.c /tmp/tmp.Q5CoXz9uJK/tree-sitter/lib/src/tree_cursor.c', DO NOT EDIT.
...
type X_IO_FILE = S_IO_FILE /* libio.h:314:25 */
...
func array__erase(tls *libc.TLS, self uintptr, element_size Size_t, index Uint32_t) { /* array.h:141:20: */
	if index < (*VoidArray)(unsafe.Pointer(self)).Size {
		...
		libc.X__assert_fail(tls, ts+84 /* "index < self->si..." */, ts+103 /* "/tmp/tmp.Q5CoXz9..." */, uint32(143), uintptr(unsafe.Pointer(&__func__114)))
	}
	var contents uintptr = (*VoidArray)(unsafe.Pointer(self)).Contents
	libc.Xmemmove(tls, (contents + uintptr((Size_t(index) * element_size))), (contents + uintptr(((Size_t(index + Uint32_t(1))) * element_size))),
		((Size_t(((*VoidArray)(unsafe.Pointer(self)).Size - index) - Uint32_t(1))) * element_size))
	(*VoidArray)(unsafe.Pointer(self)).Size--
}

var __func__114 = *(*[13]int8)(unsafe.Pointer(ts + 151 /* "array__erase" */)) /* array.h:142:49 */
...
func array__assign(tls *libc.TLS, self uintptr, other uintptr, element_size Size_t) { /* array.h:161:20: */
	...
	libc.Xmemcpy(tls, (*VoidArray)(unsafe.Pointer(self)).Contents, (*VoidArray)(unsafe.Pointer(other)).Contents, (Size_t((*VoidArray)(unsafe.Pointer(self)).Size) * element_size))
}
...
func array__splice(tls *libc.TLS, self uintptr, element_size Size_t, index Uint32_t, old_count Uint32_t, new_count Uint32_t, elements uintptr) { /* array.h:183:20: */
	...
	if old_end <= (*VoidArray)(unsafe.Pointer(self)).Size {
		...
		libc.X__assert_fail(tls, ts+164 /* "old_end <= self-..." */, ts+103 /* "/tmp/tmp.Q5CoXz9..." */, uint32(189), uintptr(unsafe.Pointer(&__func__115)))
	}
	...
	if (*VoidArray)(unsafe.Pointer(self)).Size > old_end {
		libc.Xmemmove(tls,
			(contents + uintptr((Size_t(new_end) * element_size))),
			(contents + uintptr((Size_t(old_end) * element_size))),
			((Size_t((*VoidArray)(unsafe.Pointer(self)).Size - old_end)) * element_size))
	}
	if new_count > Uint32_t(0) {
		if elements != 0 {
			libc.Xmemcpy(tls,
				(contents + uintptr((Size_t(index) * element_size))),
				elements,
...
var __func__115 = *(*[14]int8)(unsafe.Pointer(ts + 186 /* "array__splice" */)) /* array.h:185:76 */
	...
	if (*TSRangeArray)(unsafe.Pointer(self)).Size > Uint32_t(0) {
		var last_range uintptr = func() uintptr {
			if ((*TSRangeArray)(unsafe.Pointer((self))).Size - Uint32_t(1)) < (*TSRangeArray)(unsafe.Pointer((self))).Size {
				...
				libc.X__assert_fail(tls, ts+200 /* "(uint32_t)(self)..." */, ts+242 /* "/tmp/tmp.Q5CoXz9..." */, uint32(12), uintptr(unsafe.Pointer(&__func__16)))
			}
...
var __func__16 = *(*[19]int8)(unsafe.Pointer(ts + 303 /* "ts_range_array_a..." */)) /* get_changed_ranges.c:10:78 */
...
func iterator_start_position(tls *libc.TLS, self uintptr) Length { /* get_changed_ranges.c:125:15: */
	var entry = *(*TreeCursorEntry)(unsafe.Pointer(func() uintptr {
		if ((*struct {
			...
			Size     Uint32_t
			Capacity Uint32_t
		})(unsafe.Pointer((self /* &.cursor */ + 8 /* &.stack */))).Size {
		} else {
			libc.X__assert_fail(tls, ts+322 /* "(uint32_t)(&self..." */, ts+242 /* "/tmp/tmp.Q5CoXz9..." */, uint32(126), uintptr(unsafe.Pointer(&__func__17)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__17 = *(*[24]int8)(unsafe.Pointer(ts + 394 /* "iterator_start_p..." */)) /* get_changed_ranges.c:125:55 */
...
func iterator_end_position(tls *libc.TLS, self uintptr) Length { /* get_changed_ranges.c:134:15: */
	var entry = *(*TreeCursorEntry)(unsafe.Pointer(func() uintptr {
		if ((*struct {
			...
			libc.X__assert_fail(tls, ts+322 /* "(uint32_t)(&self..." */, ts+242 /* "/tmp/tmp.Q5CoXz9..." */, uint32(135), uintptr(unsafe.Pointer(&__func__18)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__18 = *(*[22]int8)(unsafe.Pointer(ts + 418 /* "iterator_end_pos..." */)) /* get_changed_ranges.c:134:53 */
...
func iterator_tree_is_visible(tls *libc.TLS, self uintptr) uint8 { /* get_changed_ranges.c:144:13: */
	...
	var entry = *(*TreeCursorEntry)(unsafe.Pointer(func() uintptr {
		if ((*struct {
			...
			libc.X__assert_fail(tls, ts+322 /* "(uint32_t)(&self..." */, ts+242 /* "/tmp/tmp.Q5CoXz9..." */, uint32(145), uintptr(unsafe.Pointer(&__func__19)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__19 = *(*[25]int8)(unsafe.Pointer(ts + 440 /* "iterator_tree_is..." */)) /* get_changed_ranges.c:144:60 */
...
func iterator_ascend(tls *libc.TLS, self uintptr) { /* get_changed_ranges.c:191:13: */
	...
	if (*TreeCursorEntry)(unsafe.Pointer((func() uintptr {
		if ((*struct {
			...
			libc.X__assert_fail(tls, ts+322 /* "(uint32_t)(&self..." */, ts+242 /* "/tmp/tmp.Q5CoXz9..." */, uint32(194), uintptr(unsafe.Pointer(&__func__20)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__20 = *(*[16]int8)(unsafe.Pointer(ts + 465 /* "iterator_ascend" */)) /* get_changed_ranges.c:191:45 */
	...
	for ok := true; ok; ok = did_descend != 0 {
		...
		var entry = *(*TreeCursorEntry)(unsafe.Pointer(func() uintptr {
			if ((*struct {
				...
				libc.X__assert_fail(tls, ts+322 /* "(uint32_t)(&self..." */, ts+242 /* "/tmp/tmp.Q5CoXz9..." */, uint32(204), uintptr(unsafe.Pointer(&__func__21)))
			}
			return ((*struct {
				Contents uintptr
				Size     Uint32_t
...
var __func__21 = *(*[17]int8)(unsafe.Pointer(ts + 481 /* "iterator_descend" */)) /* get_changed_ranges.c:198:70 */
	...
	for {
		...
		var parent uintptr = (*TreeCursorEntry)(unsafe.Pointer(func() uintptr {
			if ((*struct {
				...
				libc.X__assert_fail(tls, ts+322 /* "(uint32_t)(&self..." */, ts+242 /* "/tmp/tmp.Q5CoXz9..." */, uint32(257), uintptr(unsafe.Pointer(&__func__22)))
			}
			return ((*struct {
				Contents uintptr
				Size     Uint32_t
...
var __func__22 = *(*[17]int8)(unsafe.Pointer(ts + 498 /* "iterator_advance" */)) /* get_changed_ranges.c:241:46 */
...
func Xts_language_table_entry(tls *libc.TLS, self uintptr, state TSStateId, symbol TSSymbol, result uintptr) { /* language.c:18:6: */
	if (int32(symbol) == (int32(libc.Uint16FromInt32(-1)))) || (int32(symbol) == ((int32(libc.Uint16FromInt32(-1))) - 1)) {
		...
		if Uint32_t(symbol) < (*TSLanguage)(unsafe.Pointer(self)).Token_count {
			...
			libc.X__assert_fail(tls, ts+515 /* "symbol < self->t..." */, ts+542 /* "/tmp/tmp.Q5CoXz9..." */, uint32(29), uintptr(unsafe.Pointer(&__func__23)))
		}
...
var __func__23 = *(*[24]int8)(unsafe.Pointer(ts + 593 /* "ts_language_tabl..." */)) /* language.c:23:3 */
...
func Xts_language_symbol_for_name(tls *libc.TLS, self uintptr, string uintptr, length Uint32_t, is_named uint8) TSSymbol { /* language.c:74:10: */
	if !(libc.Xstrncmp(tls, string, ts+617 /* "ERROR" */, uint64(length)) != 0) {
				...
				if (*(*Int32_t)(unsafe.Pointer(code_point))) >= 0xe0 {
					return (libc.Bool32((func() int32 {
						if (*(*Int32_t)(unsafe.Pointer(code_point))) < 0xf0 {
							return (libc.Bool32(((int32(*(*int8)(unsafe.Pointer(ts + 630 /* " 000000000000\x1000" */ + uintptr(libc.AssignAndPtrInt32(code_point, 0xf))))) & (int32(1) << ((int32(libc.AssignUint8(&__t, *(*Uint8_t)(unsafe.Pointer((string) + uintptr(i)))))) >> 5))) != 0) && (func() bool { __t = Uint8_t(int32(__t) & (0x3f)); return 1 != 0 }())))
						}
						return (libc.Bool32(((((libc.AssignSubPtrInt32(code_point, 0xf0)) <= 4) && ((int32(*(*int8)(unsafe.Pointer(ts + 647 /* "\x00\x00\x00\x00\x00\x00\x00\x00\x1e\x0f\x0f\x0f\x00\x00\x00\x00" */ + uintptr(((int32(libc.AssignUint8(&__t, *(*Uint8_t)(unsafe.Pointer((string) + uintptr(i)))))) >> 4))))) & (int32(1) << (*(*Int32_t)(unsafe.Pointer(code_point))))) != 0)) && (func() bool {
...
func ts_lexer__advance(tls *libc.TLS, _self uintptr, skip uint8) { /* lexer.c:157:13: */
	...
	if skip != 0 {
		if (*Lexer)(unsafe.Pointer(self)).Logger.Log != 0 {
			libc.Xsnprintf(tls, self+165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), func() uintptr {
				if (32 <= (*Lexer)(unsafe.Pointer(self)).Data.Lookahead) && ((*Lexer)(unsafe.Pointer(self)).Data.Lookahead < 127) {
					return ts + 664 /* "skip character:'..." */
				}
				return ts + 684 /* "skip character:%..." */
		...
		if (*Lexer)(unsafe.Pointer(self)).Logger.Log != 0 {
			libc.Xsnprintf(tls, self+165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), func() uintptr {
				if (32 <= (*Lexer)(unsafe.Pointer(self)).Data.Lookahead) && ((*Lexer)(unsafe.Pointer(self)).Data.Lookahead < 127) {
					return ts + 702 /* "consume characte..." */
				}
				return ts + 725 /* "consume characte..." */
...
func clock_after(tls *libc.TLS, base TSClock, duration TSDuration) TSClock { /* clock.h:81:23: */
	...
	*(*X__syscall_slong_t)(unsafe.Pointer(bp /* &result */ + 8 /* &.tv_nsec */)) += X__syscall_slong_t(((duration % uint64(1000000)) * uint64(1000)))
	return *(*TSClock)(unsafe.Pointer(bp /* result */))
}
...
func reusable_node_advance(tls *libc.TLS, self uintptr) { /* reusable_node.h:39:20: */
	...
	var last_entry = *(*StackEntry)(unsafe.Pointer(func() uintptr {
		if ((*struct {
			...
			libc.X__assert_fail(tls, ts+746 /* "(uint32_t)(&self..." */, ts+804 /* "/tmp/tmp.Q5CoXz9..." */, uint32(40), uintptr(unsafe.Pointer(&__func__68)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
	...
	for ok := true; ok; ok = (ts_subtree_child_count(tls, *(*Subtree)(unsafe.Pointer(bp /* tree */))) <= next_index) {
		...
		*(*Subtree)(unsafe.Pointer(bp /* tree */)) = (*StackEntry)(unsafe.Pointer(func() uintptr {
			if ((*struct {
				...
				libc.X__assert_fail(tls, ts+746 /* "(uint32_t)(&self..." */, ts+804 /* "/tmp/tmp.Q5CoXz9..." */, uint32(52), uintptr(unsafe.Pointer(&__func__68)))
			}
			return ((*struct {
				Contents uintptr
				Size     Uint32_t
...
var __func__68 = *(*[22]int8)(unsafe.Pointer(ts + 860 /* "reusable_node_ad..." */)) /* reusable_node.h:39:62 */
...
func reusable_node_descend(tls *libc.TLS, self uintptr) uint8 { /* reusable_node.h:62:20: */
	...
	*(*StackEntry)(unsafe.Pointer(bp /* last_entry */)) = *(*StackEntry)(unsafe.Pointer(func() uintptr {
		if ((*struct {
			...
			libc.X__assert_fail(tls, ts+746 /* "(uint32_t)(&self..." */, ts+804 /* "/tmp/tmp.Q5CoXz9..." */, uint32(63), uintptr(unsafe.Pointer(&__func__69)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__69 = *(*[22]int8)(unsafe.Pointer(ts + 882 /* "reusable_node_de..." */)) /* reusable_node.h:62:62 */
...
func ts_parser__log(tls *libc.TLS, self uintptr) { /* parser.c:151:13: */
	...
	if (*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0 {
		libc.Xfprintf(tls, (*TSParser)(unsafe.Pointer(self)).Dot_graph_file, ts+905 /* "graph {\nlabel=\"" */, 0)
		{
		...
		libc.Xfprintf(tls, (*TSParser)(unsafe.Pointer(self)).Dot_graph_file, ts+921 /* "\"\n}\n\n" */, 0)
	}
}
			...
			}
			{
				...
				*(*Subtree)(unsafe.Pointer(bp + 32 /* parent */)) = *(*Subtree)(unsafe.Pointer(func() uintptr {
					if Uint32_t(0) < (*SubtreeArray)(unsafe.Pointer((bp + 8 /* &slice */ /* &.subtrees */))).Size {
						...
						libc.X__assert_fail(tls, ts+927 /* "(uint32_t)0 < (&..." */, ts+965 /* "/tmp/tmp.Q5CoXz9..." */, uint32(186), uintptr(unsafe.Pointer(&__func__70)))
					}
				...
				if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
					libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1014 /* "breakdown_top_of..." */, libc.VaList(bp, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 32 /* parent */))))))
...
var __func__70 = *(*[34]int8)(unsafe.Pointer(ts + 1048 /* "ts_parser__break..." */)) /* parser.c:173:3 */
...
func ts_parser__breakdown_lookahead(tls *libc.TLS, self uintptr, lookahead uintptr, state TSStateId, reusable_node uintptr) { /* parser.c:218:13: */
	...
	for (ts_subtree_child_count(tls, tree) > Uint32_t(0)) && (int32(ts_subtree_parse_state(tls, tree)) != int32(state)) {
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1082 /* "state_mismatch s..." */, libc.VaList(bp, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, tree))))
			ts_parser__log(tls, self)
		}
...
func ts_parser__lex(tls *libc.TLS, self uintptr, version StackVersion, parse_state TSStateId) Subtree { /* parser.c:385:16: */
	...
	if int32(lex_mode.Lex_state) == int32(libc.Uint16FromInt32(-1)) {
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1104 /* "no_lookahead_aft..." */, 0)
			ts_parser__log(tls, self)
		}
	...
	*(*Uint32_t)(unsafe.Pointer(bp + 64 /* lookahead_end_byte */)) = Uint32_t(0)
	...
	for {
		...
		if valid_external_tokens != 0 {
			if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
				libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1142 /* "lex_external sta..." */, libc.VaList(bp, int32(lex_mode.External_lex_state), (current_position.Extent.Row+Uint32_t(1)), current_position.Extent.Column))
				ts_parser__log(tls, self)
			}
		...
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1183 /* "lex_internal sta..." */, libc.VaList(bp+24, int32(lex_mode.Lex_state), (current_position.Extent.Row+Uint32_t(1)), current_position.Extent.Column))
			ts_parser__log(tls, self)
		}
		...
		if !(skipped_error != 0) {
			if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
				libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1224 /* "skip_unrecognize..." */, 0)
				ts_parser__log(tls, self)
			}
	...
	if skipped_error != 0 {
		...
		*(*Subtree)(unsafe.Pointer(bp + 72 /* result */)) = Xts_subtree_new_error(tls,
		...
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			...
			var off int32 = libc.Xsprintf(tls, buf, ts+1252 /* "lexed_lookahead ..." */, 0)
			{
				var i int32 = 0
			__1:
			...
			libc.Xsnprintf(tls, (buf + uintptr(off)), (uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE - off)), ts+1273 /* ", size:%u" */, libc.VaList(bp+48, ts_subtree_total_size(tls, *(*Subtree)(unsafe.Pointer(bp + 72 /* result */))).Bytes))
			ts_parser__log(tls, self)
		}
		...
		*(*Subtree)(unsafe.Pointer(bp + 72 /* result */)) = Xts_subtree_new_leaf(tls,
		...
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			...
			libc.Xsnprintf(tls, (buf + uintptr(off)), (uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE - off)), ts+1273 /* ", size:%u" */, libc.VaList(bp+56, ts_subtree_total_size(tls, *(*Subtree)(unsafe.Pointer(bp + 72 /* result */))).Bytes))
			ts_parser__log(tls, self)
		}
...
func ts_parser__has_included_range_difference(tls *libc.TLS, self uintptr, start_position Uint32_t, end_position Uint32_t) uint8 { /* parser.c:614:13: */
	return Xts_range_array_intersects(tls,
		(self + 1464 /* &.included_range_differences */),
	...
	for *(*uintptr)(unsafe.Pointer(libc.Xmemmove(tls, bp+64 /* &result */, func() uintptr {
		*(*Subtree)(unsafe.Pointer(bp + 80)) = reusable_node_tree(tls, (self + 1360 /* &.reusable_node */))
		...
		if byte_offset > position {
			if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
				libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1283 /* "before_reusable_..." */, libc.VaList(bp, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */))))))
				ts_parser__log(tls, self)
			}
		...
		if byte_offset < position {
			if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
				libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1314 /* "past_reusable_no..." */, libc.VaList(bp+8, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */))))))
				ts_parser__log(tls, self)
			}
		...
		if !(Xts_subtree_external_scanner_state_eq(tls, (*TSParser)(unsafe.Pointer(self)).Reusable_node.Last_external_token, last_external_token) != 0) {
			if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
				libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1343 /* "reusable_node_ha..." */, libc.VaList(bp+16, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */))))))
				ts_parser__log(tls, self)
			}
		...
		if ts_subtree_has_changes(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */))) != 0 {
			reason = ts + 1404 /* "has_changes" */
		} else if ts_subtree_is_error(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */))) != 0 {
			reason = ts + 1416 /* "is_error" */
		} else if ts_subtree_missing(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */))) != 0 {
			reason = ts + 1425 /* "is_missing" */
		} else if ts_subtree_is_fragile(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */))) != 0 {
			reason = ts + 1436 /* "is_fragile" */
		} else if ts_parser__has_included_range_difference(tls, self, byte_offset, end_byte_offset) != 0 {
			reason = ts + 1447 /* "contains_differe..." */
		}

		if reason != 0 {
			if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
				libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1481 /* "cant_reuse_node_..." */, libc.VaList(bp+24, reason, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */))))))
				ts_parser__log(tls, self)
			}
		...
		if !(ts_parser__can_reuse_first_leaf(tls, self, *(*TSStateId)(unsafe.Pointer(state)), *(*Subtree)(unsafe.Pointer(bp + 64 /* result */)), table_entry) != 0) {
			if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
				libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1508 /* "cant_reuse_node ..." */, libc.VaList(bp+40, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */)))), Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, leaf_symbol)))
				ts_parser__log(tls, self)
			}
		...
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1556 /* "reuse_node symbo..." */, libc.VaList(bp+56, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* result */))))))
			ts_parser__log(tls, self)
		}
...
func ts_parser__select_tree(tls *libc.TLS, self uintptr, left Subtree, right Subtree) uint8 { /* parser.c:710:13: */
	...
	*(*Subtree)(unsafe.Pointer(bp + 160)) = right
	...
	if ts_subtree_error_cost(tls, *(*Subtree)(unsafe.Pointer(bp + 160 /* right */))) < ts_subtree_error_cost(tls, *(*Subtree)(unsafe.Pointer(bp + 144 /* left */))) {
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1577 /* "select_smaller_e..." */, libc.VaList(bp, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 160 /* right */)))), Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 144 /* left */))))))
			ts_parser__log(tls, self)
		}
	...
	if ts_subtree_error_cost(tls, *(*Subtree)(unsafe.Pointer(bp + 144 /* left */))) < ts_subtree_error_cost(tls, *(*Subtree)(unsafe.Pointer(bp + 160 /* right */))) {
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1577 /* "select_smaller_e..." */, libc.VaList(bp+16, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 144 /* left */)))), Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 160 /* right */))))))
			ts_parser__log(tls, self)
		}
	...
	if ts_subtree_dynamic_precedence(tls, *(*Subtree)(unsafe.Pointer(bp + 160 /* right */))) > ts_subtree_dynamic_precedence(tls, *(*Subtree)(unsafe.Pointer(bp + 144 /* left */))) {
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1624 /* "select_higher_pr..." */, libc.VaList(bp+32, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 160 /* right */)))), ts_subtree_dynamic_precedence(tls, *(*Subtree)(unsafe.Pointer(bp + 160 /* right */))), Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 144 /* left */)))), ts_subtree_dynamic_precedence(tls, *(*Subtree)(unsafe.Pointer(bp + 144 /* left */)))))
			ts_parser__log(tls, self)
		}
	...
	case -1:
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1699 /* "select_earlier s..." */, libc.VaList(bp+96, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 144 /* left */)))), Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 160 /* right */))))))
			ts_parser__log(tls, self)
		}
	...
	case 1:
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1699 /* "select_earlier s..." */, libc.VaList(bp+112, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 160 /* right */)))), Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 144 /* left */))))))
			ts_parser__log(tls, self)
		}
...
func ts_parser__accept(tls *libc.TLS, self uintptr, version StackVersion, lookahead Subtree) { /* parser.c:922:13: */
	...
	if ts_subtree_is_eof(tls, lookahead) != 0 {
		...
		libc.X__assert_fail(tls, ts+1782 /* "ts_subtree_is_eo..." */, ts+965 /* "/tmp/tmp.Q5CoXz9..." */, uint32(927), uintptr(unsafe.Pointer(&__func__71)))
	}
	...
	__1:
		...
		}
		{
			...
			*(*Subtree)(unsafe.Pointer(bp + 32 /* root */)) = Subtree{}
					...
					*(*Subtree)(unsafe.Pointer(bp /* tree */)) = *(*Subtree)(unsafe.Pointer((*SubtreeArray)(unsafe.Pointer(bp+16 /* &trees */)).Contents + uintptr(j)*16))
					if !(ts_subtree_extra(tls, *(*Subtree)(unsafe.Pointer(bp /* tree */))) != 0) {
						if !((int32(*(*uint8)(unsafe.Pointer(bp /* &tree */ /* &.data */ /* &.is_inline */)) & 0x1 >> 0)) != 0) {
							...
							libc.X__assert_fail(tls, ts+1811 /* "!tree.data.is_in..." */, ts+965 /* "/tmp/tmp.Q5CoXz9..." */, uint32(938), uintptr(unsafe.Pointer(&__func__71)))
						}
			...
			if *(*uintptr)(unsafe.Pointer(bp + 32 /* &root */)) != 0 {
			} else {
				libc.X__assert_fail(tls, ts+1832 /* "root.ptr" */, ts+965 /* "/tmp/tmp.Q5CoXz9..." */, uint32(956), uintptr(unsafe.Pointer(&__func__71)))
			}
...
var __func__71 = *(*[18]int8)(unsafe.Pointer(ts + 1841 /* "ts_parser__accep..." */)) /* parser.c:926:3 */
					...
					}
					{
						...
						if ts_language_has_reduce_action(tls,
							...
							if ts_parser__do_all_potential_reductions(tls,
								...
								lookahead_symbol) != 0 {
								if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
									libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1859 /* "recover_with_mis..." */, libc.VaList(bp, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, missing_symbol), int32(Xts_stack_state(tls, (*TSParser)(unsafe.Pointer(self)).Stack, version_with_missing_tree))))
									ts_parser__log(tls, self)
								}
	...
	__7:
		...
		}
		{
			...
			if did_merge != 0 {
				...
				libc.X__assert_fail(tls, ts+1900 /* "did_merge" */, ts+965 /* "/tmp/tmp.Q5CoXz9..." */, uint32(1139), uintptr(unsafe.Pointer(&__func__72)))
			}
...
var __func__72 = *(*[24]int8)(unsafe.Pointer(ts + 1910 /* "ts_parser__handl..." */)) /* parser.c:1069:3 */
		...
		}
		{
			...
			*(*SubtreeArray)(unsafe.Pointer(bp + 56 /* error_trees */)) = Xts_stack_pop_error(tls, (*TSParser)(unsafe.Pointer(self)).Stack, (*StackSlice)(unsafe.Pointer(bp /* &slice */)).Version)
			if (*SubtreeArray)(unsafe.Pointer(bp+56 /* &error_trees */)).Size > Uint32_t(0) {
				if (*SubtreeArray)(unsafe.Pointer(bp+56 /* &error_trees */)).Size == Uint32_t(1) {
				} else {
					libc.X__assert_fail(tls, ts+1934 /* "error_trees.size..." */, ts+965 /* "/tmp/tmp.Q5CoXz9..." */, uint32(1173), uintptr(unsafe.Pointer(&__func__73)))
				}
...
var __func__73 = *(*[28]int8)(unsafe.Pointer(ts + 1956 /* "ts_parser__recov..." */)) /* parser.c:1151:3 */
...
func ts_parser__recover(tls *libc.TLS, self uintptr, version StackVersion, lookahead Subtree) { /* parser.c:1205:13: */
			...
			}
			{
				...
				if ts_language_has_actions(tls, (*TSParser)(unsafe.Pointer(self)).Language, entry.State, ts_subtree_symbol(tls, lookahead)) != 0 {
					if ts_parser__recover_to_state(tls, self, version, depth, entry.State) != 0 {
						...
						if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
							libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+1984 /* "recover_to_previ..." */, libc.VaList(bp, int32(entry.State), depth))
							ts_parser__log(tls, self)
						}
	...
	if ts_subtree_is_eof(tls, lookahead) != 0 {
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2023 /* "recover_eof" */, 0)
			ts_parser__log(tls, self)
		}
	...
	if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
		libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2035 /* "skip_token symbo..." */, libc.VaList(bp+16, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, lookahead))))
		ts_parser__log(tls, self)
	}
	...
	for {
			...
			}
			{
				*(*TSParseAction)(unsafe.Pointer(bp + 80 /* action */)) = *(*TSParseAction)(unsafe.Pointer((*TableEntry)(unsafe.Pointer(bp+48 /* &table_entry */)).Actions + uintptr(i)*8))
				...
				case TSParseActionTypeShift:
					{
						...
						if *(*uint8)(unsafe.Pointer(bp + 80 /* &action */ /* &.shift */ + 4 /* &.extra */)) != 0 {
							...
							if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
								libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2056 /* "shift_extra" */, 0)
								ts_parser__log(tls, self)
							}
							...
							if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
								libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2068 /* "shift state:%u" */, libc.VaList(bp, int32(next_state)))
								ts_parser__log(tls, self)
							}
				...
				case TSParseActionTypeReduce:
					{
						...
						if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
							libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2083 /* "reduce sym:%s, c..." */, libc.VaList(bp+8, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, *(*TSSymbol)(unsafe.Pointer(bp + 80 /* &action */ /* &.reduce */ + 2 /* &.symbol */))), int32(*(*Uint8_t)(unsafe.Pointer(bp + 80 /* &action */ /* &.reduce */ + 1 /* &.child_count */)))))
							ts_parser__log(tls, self)
						}
				...
				case TSParseActionTypeAccept:
					{
						if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
							libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2113 /* "accept" */, 0)
							ts_parser__log(tls, self)
						}
		...
		if (ts_subtree_is_keyword(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* lookahead */))) != 0) && (int32(ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* lookahead */)))) != int32((*TSLanguage)(unsafe.Pointer((*TSParser)(unsafe.Pointer(self)).Language)).Keyword_capture_token)) {
			...
			if (*TableEntry)(unsafe.Pointer(bp+48 /* &table_entry */)).Action_count > Uint32_t(0) {
				if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
					libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2120 /* "switch from_keyw..." */, libc.VaList(bp+24, Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 64 /* lookahead */)))), Xts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Language, (*TSLanguage)(unsafe.Pointer((*TSParser)(unsafe.Pointer(self)).Language)).Keyword_capture_token)))
					ts_parser__log(tls, self)
				}
		...
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2161 /* "detect_error" */, 0)
			ts_parser__log(tls, self)
		}
...
func ts_parser__condense_stack(tls *libc.TLS, self uintptr) uint32 { /* parser.c:1587:17: */
			...
			}
			{
				if Xts_stack_is_paused(tls, (*TSParser)(unsafe.Pointer(self)).Stack, i) != 0 {
					if !(has_unpaused_version != 0) && ((*TSParser)(unsafe.Pointer(self)).Accept_count < sMAX_VERSION_COUNT) {
						if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
							libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2174 /* "resume version:%..." */, libc.VaList(bp, i))
							ts_parser__log(tls, self)
						}
	...
	if made_changes != 0 {
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2192 /* "condense" */, 0)
			ts_parser__log(tls, self)
		}
...
func Xts_parser_delete(tls *libc.TLS, self uintptr) { /* parser.c:1717:6: */
	...
	if (*TSParser)(unsafe.Pointer(self)).Included_range_differences.Contents != 0 {
		array__delete(tls, (self + 1464 /* &.included_range_differences */))
	}
	if *(*uintptr)(unsafe.Pointer(self + 1448 /* &.old_tree */)) != 0 {
...
func Xts_parser_print_dot_graphs(tls *libc.TLS, self uintptr, fd int32) { /* parser.c:1775:6: */
	...
	if fd >= 0 {
		(*TSParser)(unsafe.Pointer(self)).Dot_graph_file = libc.Xfdopen(tls, fd, ts+2201 /* "a" */)
	} else {
		(*TSParser)(unsafe.Pointer(self)).Dot_graph_file = uintptr(0)
	}
}
...
func Xts_parser_parse(tls *libc.TLS, self uintptr, old_tree uintptr, input TSInput) uintptr { /* parser.c:1836:8: */
	...
	(*TSRangeArray)(unsafe.Pointer((self + 1464 /* &.included_range_differences */))).Size = Uint32_t(0)
	(*TSParser)(unsafe.Pointer(self)).Included_range_difference_index = uint32(0)

	if ts_parser_has_outstanding_parse(tls, self) != 0 {
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2203 /* "resume_parsing" */, 0)
			ts_parser__log(tls, self)
		}
		...
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2218 /* "parse_after_edit" */, 0)
			ts_parser__log(tls, self)
		}
		...
		__1:
			...
			}
			{
				...
				if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
					libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2237 /* "different_includ..." */, libc.VaList(bp, (*TSRange)(unsafe.Pointer(range1)).Start_byte, (*TSRange)(unsafe.Pointer(range1)).End_byte))
					ts_parser__log(tls, self)
				}
		...
		reusable_node_clear(tls, (self + 1360 /* &.reusable_node */))
		if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
			libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2270 /* "new_parse" */, 0)
			ts_parser__log(tls, self)
		}
	...
	if ((*TSParser)(unsafe.Pointer(self)).Lexer.Logger.Log != 0) || ((*TSParser)(unsafe.Pointer(self)).Dot_graph_file != 0) {
		libc.Xsnprintf(tls, self /* &.lexer */ +165 /* &.debug_buffer */, uint64(TREE_SITTER_SERIALIZATION_BUFFER_SIZE), ts+2343 /* "done" */, 0)
		ts_parser__log(tls, self)
	}
...
func stream_skip_whitespace(tls *libc.TLS, self uintptr) { /* query.c:327:13: */
	for {
		if libc.Xiswspace(tls, uint32((*Stream)(unsafe.Pointer(self)).Next)) != 0 {
			stream_advance(tls, self)
...
func stream_is_ident_start(tls *libc.TLS, self uintptr) uint8 { /* query.c:343:13: */
	return (uint8(libc.Bool32(((libc.Xiswalnum(tls, uint32((*Stream)(unsafe.Pointer(self)).Next)) != 0) || ((*Stream)(unsafe.Pointer(self)).Next == '_')) || ((*Stream)(unsafe.Pointer(self)).Next == '-'))))
}

func stream_scan_identifier(tls *libc.TLS, stream uintptr) { /* query.c:347:13: */
	for ok := true; ok; ok = ((((((libc.Xiswalnum(tls, uint32((*Stream)(unsafe.Pointer(stream)).Next)) != 0) || ((*Stream)(unsafe.Pointer(stream)).Next == '_')) || ((*Stream)(unsafe.Pointer(stream)).Next == '-')) || ((*Stream)(unsafe.Pointer(stream)).Next == '.')) || ((*Stream)(unsafe.Pointer(stream)).Next == '?')) || ((*Stream)(unsafe.Pointer(stream)).Next == '!')) {
...
func capture_list_pool_reset(tls *libc.TLS, self uintptr) { /* query.c:377:13: */
	...
	__1:
		...
		}
		{
			...
			(*CaptureList)(unsafe.Pointer((*CaptureListPool)(unsafe.Pointer(self)).List.Contents + uintptr(i)*16)).Size = 4294967295
...
func capture_list_pool_get_mut(tls *libc.TLS, self uintptr, id Uint16_t) uintptr { /* query.c:397:20: */
	if Uint32_t(id) < (*CaptureListPool)(unsafe.Pointer(self)).List.Size {
		...
		libc.X__assert_fail(tls, ts+2348 /* "id < self->list...." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(398), uintptr(unsafe.Pointer(&__func__76)))
	}
	return ((*CaptureListPool)(unsafe.Pointer(self)).List.Contents + uintptr(id)*16)
}

var __func__76 = *(*[26]int8)(unsafe.Pointer(ts + 2417 /* "capture_list_poo..." */)) /* query.c:397:83 */
...
func capture_list_pool_acquire(tls *libc.TLS, self uintptr) Uint16_t { /* query.c:408:17: */
	...
	if (*CaptureListPool)(unsafe.Pointer(self)).Free_capture_list_count > Uint32_t(0) {
		...
		__1:
			...
			{
				if (*CaptureList)(unsafe.Pointer((*CaptureListPool)(unsafe.Pointer(self)).List.Contents+uintptr(i)*16)).Size == (4294967295) {
...
func capture_list_pool_release(tls *libc.TLS, self uintptr, id Uint16_t) { /* query.c:432:13: */
	...
	(*CaptureList)(unsafe.Pointer((*CaptureListPool)(unsafe.Pointer(self)).List.Contents + uintptr(id)*16)).Size = 4294967295
	(*CaptureListPool)(unsafe.Pointer(self)).Free_capture_list_count++
}
...
func symbol_table_insert_name(tls *libc.TLS, self uintptr, name uintptr, length Uint32_t) Uint16_t { /* query.c:479:17: */
	...
	libc.Xmemset(tls, ((*struct {
		...
		Size     Uint32_t
		Capacity Uint32_t
	})(unsafe.Pointer((self /* &.characters */))).Size)), 0, ((uint64(length + Uint32_t(1))) * uint64(unsafe.Sizeof(int8(0)))))
	*(*Uint32_t)(unsafe.Pointer((self /* &.characters */) + 8 /* &.size */)) += (length + Uint32_t(1))
	libc.Xmemcpy(tls, ((*SymbolTable)(unsafe.Pointer(self)).Characters.Contents + uintptr(slice.Offset)), name, uint64(length))
										...
										if *(*uint32)(unsafe.Pointer(bp + 204 /* exists */)) != 0 {
											...
											if ((*AnalysisSubgraph)(unsafe.Pointer(subgraph)).Nodes.Size == Uint32_t(0)) || (int32((*AnalysisSubgraphNode)(unsafe.Pointer((func() uintptr {
												if ((*struct {
													...
													Size     Uint32_t
													Capacity Uint32_t
												})(unsafe.Pointer((subgraph + 24 /* &.nodes */))).Size {
												} else {
													libc.X__assert_fail(tls, ts+2443 /* "(uint32_t)(&subg..." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(823), uintptr(unsafe.Pointer(&__func__77)))
												}
												return ((*struct {
													Contents uintptr
													Size     Uint32_t
							...
							if *(*uint32)(unsafe.Pointer(bp + 204 /* exists */)) != 0 {
								...
								if ((*AnalysisSubgraph)(unsafe.Pointer(subgraph)).Start_states.Size == Uint32_t(0)) || (int32(*(*TSStateId)(unsafe.Pointer(func() uintptr {
									if ((*struct {
										...
										Size     Uint32_t
										Capacity Uint32_t
									})(unsafe.Pointer((subgraph + 8 /* &.start_states */))).Size {
									} else {
										libc.X__assert_fail(tls, ts+2509 /* "(uint32_t)(&subg..." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(861), uintptr(unsafe.Pointer(&__func__77)))
									}
									return ((*struct {
										Contents uintptr
										Size     Uint32_t
	...
	__28:
		...
		}
		{
			...
			if !(*(*uint32)(unsafe.Pointer(bp + 272 /* exists */)) != 0) {
				...
				if *(*Uint32_t)(unsafe.Pointer(bp + 280 /* exists */)) != 0 {
				} else {
					libc.X__assert_fail(tls, ts+2589 /* "exists" */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(955), uintptr(unsafe.Pointer(&__func__77)))
				}
					...
					}
					{
						...
						if (*AnalysisStateSet)(unsafe.Pointer(bp+336 /* &next_states */)).Size > Uint32_t(0) {
							var comparison int32 = analysis_state__compare_position(tls, state, func() uintptr {
								if ((*AnalysisStateSet)(unsafe.Pointer((bp + 336 /* &next_states */))).Size - Uint32_t(1)) < (*AnalysisStateSet)(unsafe.Pointer((bp + 336 /* &next_states */))).Size {
								} else {
									libc.X__assert_fail(tls, ts+2596 /* "(uint32_t)(&next..." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(1046), uintptr(unsafe.Pointer(&__func__77)))
								}
			...
			if ((all_patterns_are_valid != 0) && !(can_finish_pattern != 0)) && !(did_exceed_max_depth != 0) {
				if (*struct {
					...
					libc.X__assert_fail(tls, ts+2654 /* "final_step_indic..." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(1269), uintptr(unsafe.Pointer(&__func__77)))
				}
				var impossible_step_index Uint16_t = *(*Uint16_t)(unsafe.Pointer(func() uintptr {
					if ((*struct {
						...
						libc.X__assert_fail(tls, ts+2682 /* "(uint32_t)(&fina..." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(1270), uintptr(unsafe.Pointer(&__func__77)))
					}
					return ((*struct {
						Contents uintptr
						Size     Uint32_t
...
var __func__77 = *(*[27]int8)(unsafe.Pointer(ts + 2754 /* "ts_query__analyz..." */)) /* query.c:746:79 */
...
func ts_query__parse_pattern(tls *libc.TLS, self uintptr, stream uintptr, depth Uint32_t, is_immediate uint8) TSQueryError { /* query.c:1620:21: */
	...
	if ((*TSQuery)(unsafe.Pointer(self)).Step_offsets.Size == Uint32_t(0)) || (Uint32_t((*StepOffset)(unsafe.Pointer((func() uintptr {
		if ((*struct {
			...
			Size     Uint32_t
			Capacity Uint32_t
		})(unsafe.Pointer((self + 128 /* &.step_offsets */))).Size {
		} else {
			libc.X__assert_fail(tls, ts+2781 /* "(uint32_t)(&self..." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(1634), uintptr(unsafe.Pointer(&__func__78)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
			...
			if Xts_language_symbol_metadata(tls, (*TSQuery)(unsafe.Pointer(self)).Language, symbol).Supertype != 0 {
				var step uintptr = func() uintptr {
					if ((*struct {
						...
						Size     Uint32_t
						Capacity Uint32_t
					})(unsafe.Pointer((self + 64 /* &.steps */))).Size {
					} else {
						libc.X__assert_fail(tls, ts+2853 /* "(uint32_t)(&self..." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(1775), uintptr(unsafe.Pointer(&__func__78)))
					}
					return ((*struct {
						Contents uintptr
						Size     Uint32_t
			...
			if (*Stream)(unsafe.Pointer(stream)).Next == '/' {
				...
				var step uintptr = func() uintptr {
					if ((*struct {
						...
						libc.X__assert_fail(tls, ts+2853 /* "(uint32_t)(&self..." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(1792), uintptr(unsafe.Pointer(&__func__78)))
					}
					return ((*struct {
						Contents uintptr
						Size     Uint32_t
...
var __func__78 = *(*[24]int8)(unsafe.Pointer(ts + 2911 /* "ts_query__parse_..." */)) /* query.c:1625:3 */
		...
		*(*QueryStep)(unsafe.Pointer((*struct {
		...
		var pattern uintptr = func() uintptr {
			if ((*struct {
				...
				Size     Uint32_t
				Capacity Uint32_t
			})(unsafe.Pointer((self + 112 /* &.patterns */))).Size {
			} else {
				libc.X__assert_fail(tls, ts+2935 /* "(uint32_t)(&self..." */, ts+2369 /* "/tmp/tmp.Q5CoXz9..." */, uint32(2104), uintptr(unsafe.Pointer(&__func__79)))
			}
			return ((*struct {
				Contents uintptr
				Size     Uint32_t
...
var __func__79 = *(*[13]int8)(unsafe.Pointer(ts + 2999 /* "ts_query_new" */)) /* query.c:2071:3 */
...
func stack_node_retain(tls *libc.TLS, self uintptr) { /* stack.c:86:13: */
	...
	if (*StackNode)(unsafe.Pointer(self)).Ref_count > Uint32_t(0) {
		...
		libc.X__assert_fail(tls, ts+3012 /* "self->ref_count ..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(89), uintptr(unsafe.Pointer(&__func__82)))
	}
	(*StackNode)(unsafe.Pointer(self)).Ref_count++
	if (*StackNode)(unsafe.Pointer(self)).Ref_count != Uint32_t(0) {
	} else {
		libc.X__assert_fail(tls, ts+3080 /* "self->ref_count ..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(91), uintptr(unsafe.Pointer(&__func__82)))
	}
}

var __func__82 = *(*[18]int8)(unsafe.Pointer(ts + 3101 /* "stack_node_retai..." */)) /* stack.c:86:48 */
...
recur:
	...
	goto __2
__1:
	libc.X__assert_fail(tls, ts+3080 /* "self->ref_count ..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(96), uintptr(unsafe.Pointer(&__func__83)))
__2:
	;
	(*StackNode)(unsafe.Pointer(self)).Ref_count--
	if !((*StackNode)(unsafe.Pointer(self)).Ref_count > Uint32_t(0)) {
...
var __func__83 = *(*[19]int8)(unsafe.Pointer(ts + 3119 /* "stack_node_relea..." */)) /* stack.c:94:98 */
...
func stack__iter(tls *libc.TLS, self uintptr, version StackVersion, callback StackCallback, payload uintptr, goal_subtree_count int32) StackSliceArray { /* stack.c:274:24: */
	...
	var head uintptr = func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(280), uintptr(unsafe.Pointer(&__func__84)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
							...
							*(*StackIterator)(unsafe.Pointer((*struct {
							...
							next_iterator = func() uintptr {
								if ((*struct {
									...
									Size     Uint32_t
									Capacity Uint32_t
								})(unsafe.Pointer((self + 32 /* &.iterators */))).Size {
								} else {
									libc.X__assert_fail(tls, ts+3179 /* "(uint32_t)(&self..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(338), uintptr(unsafe.Pointer(&__func__84)))
								}
								return ((*struct {
									Contents uintptr
									Size     Uint32_t
...
var __func__84 = *(*[12]int8)(unsafe.Pointer(ts + 3245 /* "stack__iter" */)) /* stack.c:276:60 */
...
func Xts_stack_state(tls *libc.TLS, self uintptr, version StackVersion) TSStateId { /* stack.c:408:11: */
	return (*StackNode)(unsafe.Pointer((*StackHead)(unsafe.Pointer(func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(409), uintptr(unsafe.Pointer(&__func__85)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__85 = *(*[15]int8)(unsafe.Pointer(ts + 3257 /* "ts_stack_state" */)) /* stack.c:408:67 */
...
func Xts_stack_position(tls *libc.TLS, self uintptr, version StackVersion) Length { /* stack.c:412:8: */
	return (*StackNode)(unsafe.Pointer((*StackHead)(unsafe.Pointer(func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(413), uintptr(unsafe.Pointer(&__func__86)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__86 = *(*[18]int8)(unsafe.Pointer(ts + 3272 /* "ts_stack_positio..." */)) /* stack.c:412:67 */
...
func Xts_stack_last_external_token(tls *libc.TLS, self uintptr, version StackVersion) Subtree { /* stack.c:416:9: */
	return (*StackHead)(unsafe.Pointer(func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(417), uintptr(unsafe.Pointer(&__func__87)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__87 = *(*[29]int8)(unsafe.Pointer(ts + 3290 /* "ts_stack_last_ex..." */)) /* stack.c:416:79 */
	...
	*(*Subtree)(unsafe.Pointer(bp)) = token
	...
	var head uintptr = func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(421), uintptr(unsafe.Pointer(&__func__88)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__88 = *(*[33]int8)(unsafe.Pointer(ts + 3319 /* "ts_stack_set_las..." */)) /* stack.c:420:89 */
...
func Xts_stack_error_cost(tls *libc.TLS, self uintptr, version StackVersion) uint32 { /* stack.c:427:10: */
	var head uintptr = func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(428), uintptr(unsafe.Pointer(&__func__89)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__89 = *(*[20]int8)(unsafe.Pointer(ts + 3352 /* "ts_stack_error_c..." */)) /* stack.c:427:71 */
...
func Xts_stack_node_count_since_error(tls *libc.TLS, self uintptr, version StackVersion) uint32 { /* stack.c:438:10: */
	var head uintptr = func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(439), uintptr(unsafe.Pointer(&__func__90)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__90 = *(*[32]int8)(unsafe.Pointer(ts + 3372 /* "ts_stack_node_co..." */)) /* stack.c:438:83 */
	...
	*(*Subtree)(unsafe.Pointer(bp)) = subtree
	...
	var head uintptr = func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(448), uintptr(unsafe.Pointer(&__func__91)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__91 = *(*[14]int8)(unsafe.Pointer(ts + 3404 /* "ts_stack_push" */)) /* stack.c:447:51 */
...
func Xts_stack_pop_error(tls *libc.TLS, self uintptr, version StackVersion) SubtreeArray { /* stack.c:519:14: */
	...
	var node uintptr = (*StackHead)(unsafe.Pointer(func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(520), uintptr(unsafe.Pointer(&__func__92)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
				...
				*(*uint8)(unsafe.Pointer(bp /* found_error */)) = uint8(False)
				...
				if pop.Size > Uint32_t(0) {
					if pop.Size == Uint32_t(1) {
						...
						libc.X__assert_fail(tls, ts+3418 /* "pop.size == 1" */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(526), uintptr(unsafe.Pointer(&__func__92)))
					}
					Xts_stack_renumber_version(tls, self, (*StackSlice)(unsafe.Pointer(pop.Contents)).Version, version)
...
var __func__92 = *(*[19]int8)(unsafe.Pointer(ts + 3432 /* "ts_stack_pop_err..." */)) /* stack.c:519:68 */
...
func Xts_stack_get_summary(tls *libc.TLS, self uintptr, version StackVersion) uintptr { /* stack.c:583:14: */
	return (*StackHead)(unsafe.Pointer(func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(584), uintptr(unsafe.Pointer(&__func__93)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__93 = *(*[21]int8)(unsafe.Pointer(ts + 3451 /* "ts_stack_get_sum..." */)) /* stack.c:583:71 */
...
func Xts_stack_dynamic_precedence(tls *libc.TLS, self uintptr, version StackVersion) int32 { /* stack.c:587:5: */
	return (*StackNode)(unsafe.Pointer((*StackHead)(unsafe.Pointer(func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(588), uintptr(unsafe.Pointer(&__func__94)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__94 = *(*[28]int8)(unsafe.Pointer(ts + 3472 /* "ts_stack_dynamic..." */)) /* stack.c:587:68 */
...
func Xts_stack_has_advanced_since_error(tls *libc.TLS, self uintptr, version StackVersion) uint8 { /* stack.c:591:6: */
	...
	var head uintptr = func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(592), uintptr(unsafe.Pointer(&__func__95)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__95 = *(*[34]int8)(unsafe.Pointer(ts + 3500 /* "ts_stack_has_adv..." */)) /* stack.c:591:81 */
...
func Xts_stack_remove_version(tls *libc.TLS, self uintptr, version StackVersion) { /* stack.c:615:6: */
	stack_head_delete(tls, func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(616), uintptr(unsafe.Pointer(&__func__96)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__96 = *(*[24]int8)(unsafe.Pointer(ts + 3534 /* "ts_stack_remove_..." */)) /* stack.c:615:65 */
...
func Xts_stack_renumber_version(tls *libc.TLS, self uintptr, v1 StackVersion, v2 StackVersion) { /* stack.c:620:6: */
	...
	if v2 < v1 {
		...
		libc.X__assert_fail(tls, ts+3558 /* "v2 < v1" */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(622), uintptr(unsafe.Pointer(&__func__97)))
	}
	if v1 < (*Stack)(unsafe.Pointer(self)).Heads.Size {
	} else {
		libc.X__assert_fail(tls, ts+3566 /* "(uint32_t)v1 < s..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(623), uintptr(unsafe.Pointer(&__func__97)))
	}
...
var __func__97 = *(*[26]int8)(unsafe.Pointer(ts + 3598 /* "ts_stack_renumbe..." */)) /* stack.c:620:79 */
...
func Xts_stack_copy_version(tls *libc.TLS, self uintptr, version StackVersion) StackVersion { /* stack.c:641:14: */
	if version < (*Stack)(unsafe.Pointer(self)).Heads.Size {
		...
		libc.X__assert_fail(tls, ts+3624 /* "version < self->..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(642), uintptr(unsafe.Pointer(&__func__98)))
	}
	array__grow(tls, (self /* &.heads */), uint64(1), uint64(unsafe.Sizeof(StackHead{})))
	*(*StackHead)(unsafe.Pointer((*struct {
		Contents uintptr
	...
	var head uintptr = func() uintptr {
		if ((*struct {
			...
			libc.X__assert_fail(tls, ts+3651 /* "(uint32_t)(&self..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(644), uintptr(unsafe.Pointer(&__func__98)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__98 = *(*[22]int8)(unsafe.Pointer(ts + 3709 /* "ts_stack_copy_ve..." */)) /* stack.c:641:71 */
...
func Xts_stack_halt(tls *libc.TLS, self uintptr, version StackVersion) { /* stack.c:677:6: */
	(*StackHead)(unsafe.Pointer(func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(678), uintptr(unsafe.Pointer(&__func__99)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__99 = *(*[14]int8)(unsafe.Pointer(ts + 3731 /* "ts_stack_halt" */)) /* stack.c:677:55 */
...
func Xts_stack_pause(tls *libc.TLS, self uintptr, version StackVersion, lookahead TSSymbol) { /* stack.c:681:6: */
	var head uintptr = func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(682), uintptr(unsafe.Pointer(&__func__100)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__100 = *(*[15]int8)(unsafe.Pointer(ts + 3745 /* "ts_stack_pause" */)) /* stack.c:681:76 */
...
func Xts_stack_is_active(tls *libc.TLS, self uintptr, version StackVersion) uint8 { /* stack.c:688:6: */
	return (uint8(libc.Bool32((*StackHead)(unsafe.Pointer((func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(689), uintptr(unsafe.Pointer(&__func__101)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__101 = *(*[19]int8)(unsafe.Pointer(ts + 3760 /* "ts_stack_is_acti..." */)) /* stack.c:688:66 */
...
func Xts_stack_is_halted(tls *libc.TLS, self uintptr, version StackVersion) uint8 { /* stack.c:692:6: */
	return (uint8(libc.Bool32((*StackHead)(unsafe.Pointer((func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(693), uintptr(unsafe.Pointer(&__func__102)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__102 = *(*[19]int8)(unsafe.Pointer(ts + 3779 /* "ts_stack_is_halt..." */)) /* stack.c:692:66 */
...
func Xts_stack_is_paused(tls *libc.TLS, self uintptr, version StackVersion) uint8 { /* stack.c:696:6: */
	return (uint8(libc.Bool32((*StackHead)(unsafe.Pointer((func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(697), uintptr(unsafe.Pointer(&__func__103)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__103 = *(*[19]int8)(unsafe.Pointer(ts + 3798 /* "ts_stack_is_paus..." */)) /* stack.c:696:66 */
...
func Xts_stack_resume(tls *libc.TLS, self uintptr, version StackVersion) TSSymbol { /* stack.c:700:10: */
	var head uintptr = func() uintptr {
		if version < (*struct {
			...
			libc.X__assert_fail(tls, ts+3138 /* "(uint32_t)versio..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(701), uintptr(unsafe.Pointer(&__func__104)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
	...
	if (*StackHead)(unsafe.Pointer(head)).Status == StackStatusPaused {
		...
		libc.X__assert_fail(tls, ts+3817 /* "head->status == ..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(702), uintptr(unsafe.Pointer(&__func__104)))
	}
...
var __func__104 = *(*[16]int8)(unsafe.Pointer(ts + 3851 /* "ts_stack_resume" */)) /* stack.c:700:61 */
...
func Xts_stack_print_dot_graph(tls *libc.TLS, self uintptr, language uintptr, f uintptr) uint8 { /* stack.c:723:6: */
	...
	libc.Xfprintf(tls, f, ts+3867 /* "digraph stack {\n" */, 0)
	libc.Xfprintf(tls, f, ts+3884 /* "rankdir=\"RL\";\n" */, 0)
	libc.Xfprintf(tls, f, ts+3899 /* "edge [arrowhead=..." */, 0)
	...
	*(*struct {
	...
	__1:
		...
		}
		{
			...
			libc.Xfprintf(tls, f, ts+3922 /* "node_head_%u [sh..." */, libc.VaList(bp, i))
			libc.Xfprintf(tls, f, ts+3959 /* "node_head_%u -> ..." */, libc.VaList(bp+8, i, (*StackHead)(unsafe.Pointer(head)).Node))

			if (*StackHead)(unsafe.Pointer(head)).Status == StackStatusPaused {
				libc.Xfprintf(tls, f, ts+3985 /* "color=red " */, 0)
			}
			libc.Xfprintf(tls, f,
				ts+3996, /* "label=%u, fontco..." */
				libc.VaList(bp+24, i,
					Xts_stack_node_count_since_error(tls, self, i),
					Xts_stack_error_cost(tls, self, i)))

			if (*StackHead)(unsafe.Pointer(head)).Summary != 0 {
				libc.Xfprintf(tls, f, ts+4080 /* "\nsummary_size: %..." */, libc.VaList(bp+48, (*StackSummary)(unsafe.Pointer((*StackHead)(unsafe.Pointer(head)).Summary)).Size))
			}
			...
			if *(*uintptr)(unsafe.Pointer(head + 8 /* &.last_external_token */)) != 0 {
				...
				__4:
					...
					libc.Xfprintf(tls, f, ts+4123 /* " %2X" */, libc.VaList(bp+56, int32(*(*int8)(unsafe.Pointer(data + uintptr(j))))))
					goto __5
				__5:
					j++
					goto __4
	...
	for !(all_iterators_done != 0) {
		...
		__7:
			...
			}
			{
				...
				libc.Xfprintf(tls, f, ts+4132 /* "node_%p [" */, libc.VaList(bp+64, node))
				if int32((*StackNode)(unsafe.Pointer(node)).State) == ERROR_STATE {
					libc.Xfprintf(tls, f, ts+4142 /* "label=\"?\"" */, 0)
					...
					libc.Xfprintf(tls, f, ts+4152 /* "shape=point marg..." */, 0)
				} else {
					libc.Xfprintf(tls, f, ts+4182 /* "label=\"%d\"" */, libc.VaList(bp+72, int32((*StackNode)(unsafe.Pointer(node)).State)))
				}

				libc.Xfprintf(tls,
					f,
					ts+4193, /* " tooltip=\"positi..." */
				...
				__13:
					...
					}
					{
						*(*StackLink)(unsafe.Pointer(bp + 160 /* link */)) = *(*StackLink)(unsafe.Pointer((node + 16 /* &.links */) + uintptr(j1)*32))
						libc.Xfprintf(tls, f, ts+4275 /* "node_%p -> node_..." */, libc.VaList(bp+120, node, (*StackLink)(unsafe.Pointer(bp+160 /* &link */)).Node))
						if (*StackLink)(unsafe.Pointer(bp+160 /* &link */)).Is_pending != 0 {
							libc.Xfprintf(tls, f, ts+4296 /* "style=dashed " */, 0)
						}
						if (*(*uintptr)(unsafe.Pointer(bp + 160 /* &link */ + 8 /* &.subtree */)) != 0) && (ts_subtree_extra(tls, (*StackLink)(unsafe.Pointer(bp+160 /* &link */)).Subtree) != 0) {
							libc.Xfprintf(tls, f, ts+4310 /* "fontcolor=gray " */, 0)
						}

						if !(int32(*(*uintptr)(unsafe.Pointer(bp + 160 /* &link */ + 8 /* &.subtree */))) != 0) {
							libc.Xfprintf(tls, f, ts+4326 /* "color=red" */, 0)
						} else {
							libc.Xfprintf(tls, f, ts+4336 /* "label=\"" */, 0)
							...
							__16:
								...
								}
								{
									if (int32(*(*int8)(unsafe.Pointer(c))) == 34) || (int32(*(*int8)(unsafe.Pointer(c))) == '\\') {
										libc.Xfprintf(tls, f, ts+4346 /* "\\" */, 0)
									}
									libc.Xfprintf(tls, f, ts+4348 /* "%c" */, libc.VaList(bp+136, int32(*(*int8)(unsafe.Pointer(c)))))
							...
							libc.Xfprintf(tls, f, ts+4351 /* "\"" */, 0)
							libc.Xfprintf(tls,
								f,
								ts+4353, /* "labeltooltip=\"er..." */
							...
							*(*StackIterator)(unsafe.Pointer((*struct {
							...
							next_iterator = func() uintptr {
								if ((*struct {
									...
									libc.X__assert_fail(tls, ts+3179 /* "(uint32_t)(&self..." */, ts+3032 /* "/tmp/tmp.Q5CoXz9..." */, uint32(842), uintptr(unsafe.Pointer(&__func__105)))
								}
								return ((*struct {
									Contents uintptr
									Size     Uint32_t
...
var __func__105 = *(*[25]int8)(unsafe.Pointer(ts + 4413 /* "ts_stack_print_d..." */)) /* stack.c:723:81 */
...
func Xts_external_scanner_state_init(tls *libc.TLS, self uintptr, data uintptr, length uint32) { /* subtree.c:28:6: */
	...
	if uint64(length) > uint64(unsafe.Sizeof([24]int8{})) {
		*(*uintptr)(unsafe.Pointer(self /* &.long_data */)) = ts_malloc_default(tls, uint64(length))
		libc.Xmemcpy(tls, *(*uintptr)(unsafe.Pointer(self)), data, uint64(length))
	} else {
		libc.Xmemcpy(tls, self /* &.short_data */, data, uint64(length))
	}
}
	...
	*(*ExternalScannerState)(unsafe.Pointer(bp /* result */)) = *(*ExternalScannerState)(unsafe.Pointer(self))
	if uint64((*ExternalScannerState)(unsafe.Pointer(self)).Length) > uint64(unsafe.Sizeof([24]int8{})) {
		*(*uintptr)(unsafe.Pointer(bp /* &result */ /* &.long_data */)) = ts_malloc_default(tls, uint64((*ExternalScannerState)(unsafe.Pointer(self)).Length))
		libc.Xmemcpy(tls, *(*uintptr)(unsafe.Pointer(bp /* &result */ /* &.long_data */)), *(*uintptr)(unsafe.Pointer(self)), uint64((*ExternalScannerState)(unsafe.Pointer(self)).Length))
	}
...
func Xts_subtree_array_copy(tls *libc.TLS, self SubtreeArray, dest uintptr) { /* subtree.c:70:6: */
	...
	if self.Capacity > Uint32_t(0) {
		...
		libc.Xmemcpy(tls, (*SubtreeArray)(unsafe.Pointer(dest)).Contents, self.Contents, (uint64(self.Size) * uint64(unsafe.Sizeof(Subtree{}))))
		{
			var i Uint32_t = Uint32_t(0)
		__1:
			if !(i < self.Size) {
...
func Xts_subtree_set_symbol(tls *libc.TLS, self uintptr, symbol TSSymbol, language uintptr) { /* subtree.c:226:6: */
	...
	if (uint8(int32(*(*uint8)(unsafe.Pointer(self /* &.data */ /* &.is_inline */)) & 0x1 >> 0))) != 0 {
		if int32(symbol) < (255) {
			...
			libc.X__assert_fail(tls, ts+4438 /* "symbol < (255)" */, ts+4453 /* "/tmp/tmp.Q5CoXz9..." */, uint32(233), uintptr(unsafe.Pointer(&__func__108)))
		}
...
var __func__108 = *(*[22]int8)(unsafe.Pointer(ts + 4503 /* "ts_subtree_set_s..." */)) /* subtree.c:230:3 */
...
func Xts_subtree_summarize_children(tls *libc.TLS, self MutableSubtree, language uintptr) { /* subtree.c:371:6: */
	...
	*(*MutableSubtree)(unsafe.Pointer(bp)) = self
	...
	if !((int32(*(*uint8)(unsafe.Pointer(bp /* &self */ /* &.data */ /* &.is_inline */)) & 0x1 >> 0)) != 0) {
		...
		libc.X__assert_fail(tls, ts+4525 /* "!self.data.is_in..." */, ts+4453 /* "/tmp/tmp.Q5CoXz9..." */, uint32(375), uintptr(unsafe.Pointer(&__func__109)))
	}
...
var __func__109 = *(*[30]int8)(unsafe.Pointer(ts + 4546 /* "ts_subtree_summa..." */)) /* subtree.c:374:3 */
...
func Xts_subtree_retain(tls *libc.TLS, self Subtree) { /* subtree.c:568:6: */
	...
	*(*Subtree)(unsafe.Pointer(bp)) = self
	...
	if (*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp /* &self */)))).Ref_count > Uint32_t(0) {
		...
		libc.X__assert_fail(tls, ts+4576 /* "self.ptr->ref_co..." */, ts+4453 /* "/tmp/tmp.Q5CoXz9..." */, uint32(570), uintptr(unsafe.Pointer(&__func__110)))
	}
	atomic_inc(tls, (*(*uintptr)(unsafe.Pointer(bp /* &self */)) /* &.ref_count */))
	if (*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp /* &self */)))).Ref_count != Uint32_t(0) {
	} else {
		libc.X__assert_fail(tls, ts+4600 /* "self.ptr->ref_co..." */, ts+4453 /* "/tmp/tmp.Q5CoXz9..." */, uint32(572), uintptr(unsafe.Pointer(&__func__110)))
	}
}

var __func__110 = *(*[18]int8)(unsafe.Pointer(ts + 4625 /* "ts_subtree_retai..." */)) /* subtree.c:568:38 */
...
func Xts_subtree_release(tls *libc.TLS, pool uintptr, self Subtree) { /* subtree.c:575:6: */
	...
	*(*Subtree)(unsafe.Pointer(bp)) = self
	...
	if (*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp /* &self */)))).Ref_count > Uint32_t(0) {
		...
		libc.X__assert_fail(tls, ts+4576 /* "self.ptr->ref_co..." */, ts+4453 /* "/tmp/tmp.Q5CoXz9..." */, uint32(579), uintptr(unsafe.Pointer(&__func__111)))
	}
			...
			__1:
				...
				}
				{
					*(*Subtree)(unsafe.Pointer(bp + 32 /* child */)) = *(*Subtree)(unsafe.Pointer(children + uintptr(i)*16))
					...
					if (*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32 /* &child */)))).Ref_count > Uint32_t(0) {
					} else {
						libc.X__assert_fail(tls, ts+4643 /* "child.ptr->ref_c..." */, ts+4453 /* "/tmp/tmp.Q5CoXz9..." */, uint32(591), uintptr(unsafe.Pointer(&__func__111)))
					}
...
var __func__111 = *(*[19]int8)(unsafe.Pointer(ts + 4668 /* "ts_subtree_relea..." */)) /* subtree.c:575:58 */
...
func ts_subtree__write_char_to_string(tls *libc.TLS, s uintptr, n Size_t, c Int32_t) Size_t { /* subtree.c:838:15: */
	...
	if c == -1 {
		return Size_t(libc.Xsnprintf(tls, s, n, ts+4687 /* "INVALID" */, 0))
	} else if c == 0 {
		return Size_t(libc.Xsnprintf(tls, s, n, ts+4695 /* "'\\0'" */, 0))
	} else if c == '\n' {
		return Size_t(libc.Xsnprintf(tls, s, n, ts+4700 /* "'\\n'" */, 0))
	} else if c == '\t' {
		return Size_t(libc.Xsnprintf(tls, s, n, ts+4705 /* "'\\t'" */, 0))
	} else if c == '\r' {
		return Size_t(libc.Xsnprintf(tls, s, n, ts+4710 /* "'\\r'" */, 0))
		...
		return Size_t(libc.Xsnprintf(tls, s, n, ts+4715 /* "'%c'" */, libc.VaList(bp, c)))
	} else {
		return Size_t(libc.Xsnprintf(tls, s, n, ts+4720 /* "%d" */, libc.VaList(bp+8, c)))
	}
	return Size_t(0)
}
...
func ts_subtree__write_dot_string(tls *libc.TLS, f uintptr, string uintptr) { /* subtree.c:855:13: */
	...
	__1:
		...
		{
			if int32(*(*int8)(unsafe.Pointer(c))) == '"' {
				libc.Xfputs(tls, ts+4723 /* "\\\"" */, f)
			} else if int32(*(*int8)(unsafe.Pointer(c))) == '\n' {
				libc.Xfputs(tls, ts+4726 /* "\\n" */, f)
			} else {
...
var sROOT_FIELD uintptr = ts + 4729 /* "__ROOT__" */ /* subtree.c:867:19 */
...
func ts_subtree__write_to_string(tls *libc.TLS, self Subtree, string uintptr, limit Size_t, language uintptr, include_all uint8, alias_symbol TSSymbol, alias_is_named uint8, field_name uintptr) Size_t { /* subtree.c:869:15: */
	...
	*(*uintptr)(unsafe.Pointer(bp + 64)) = string
	...
	if !(int32(*(*uintptr)(unsafe.Pointer(bp + 40 /* &self */))) != 0) {
		return Size_t(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(bp + 64 /* string */)), limit, ts+4738 /* "(NULL)" */, 0))
	}
	...
	*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) = *(*uintptr)(unsafe.Pointer(bp + 64 /* string */))
	...
	if is_visible != 0 {
		if !(is_root != 0) {
			*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, ts+4745 /* " " */, 0))
			if field_name != 0 {
				*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, ts+4747 /* "%s: " */, libc.VaList(bp, field_name)))
			}
		}
		...
		if ((ts_subtree_is_error(tls, *(*Subtree)(unsafe.Pointer(bp + 40 /* self */))) != 0) && (ts_subtree_child_count(tls, *(*Subtree)(unsafe.Pointer(bp + 40 /* self */))) == Uint32_t(0))) && ((*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 40 /* &self */)))).Size.Bytes > Uint32_t(0)) {
			*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, ts+4752 /* "(UNEXPECTED " */, 0))
			*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(ts_subtree__write_char_to_string(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, *(*Int32_t)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 40 /* &self */)) + 48))))
			...
			if ts_subtree_missing(tls, *(*Subtree)(unsafe.Pointer(bp + 40 /* self */))) != 0 {
				*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, ts+4765 /* "(MISSING " */, 0))
				if (alias_is_named != 0) || (ts_subtree_named(tls, *(*Subtree)(unsafe.Pointer(bp + 40 /* self */))) != 0) {
					*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, ts+4775 /* "%s" */, libc.VaList(bp+8, symbol_name)))
				} else {
					*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, ts+4778 /* "\"%s\"" */, libc.VaList(bp+16, symbol_name)))
				}
			} else {
				*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, ts+4783 /* "(%s" */, libc.VaList(bp+24, symbol_name)))
			}
		}
	} else if is_root != 0 {
		var symbol TSSymbol = ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 40 /* self */)))
		var symbol_name uintptr = Xts_language_symbol_name(tls, language, symbol)
		*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, ts+4787 /* "(\"%s\")" */, libc.VaList(bp+32, symbol_name)))
	}
	...
	if is_visible != 0 {
		*(*uintptr)(unsafe.Pointer(bp + 56 /* cursor */)) += uintptr(libc.Xsnprintf(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, ts+4794 /* ")" */, 0))
	}
...
func Xts_subtree__print_dot_graph(tls *libc.TLS, self uintptr, start_offset Uint32_t, language uintptr, alias_symbol TSSymbol, f uintptr) { /* subtree.c:989:6: */
	...
	libc.Xfprintf(tls, f, ts+4796 /* "tree_%p [label=\"" */, libc.VaList(bp, self))
	...
	if ts_subtree_child_count(tls, *(*Subtree)(unsafe.Pointer(self))) == Uint32_t(0) {
		libc.Xfprintf(tls, f, ts+4813 /* ", shape=plaintex..." */, 0)
	}
	if ts_subtree_extra(tls, *(*Subtree)(unsafe.Pointer(self))) != 0 {
		libc.Xfprintf(tls, f, ts+4831 /* ", fontcolor=gray" */, 0)
	}

	libc.Xfprintf(tls, f,

		ts+4848, /* ", tooltip=\"range..." */
	...
	__1:
		...
		}
		{
			...
			libc.Xfprintf(tls, f, ts+4991 /* "tree_%p -> tree_..." */, libc.VaList(bp+80, self, child, i))
...
func Xts_subtree_print_dot_graph(tls *libc.TLS, self Subtree, language uintptr, f uintptr) { /* subtree.c:1042:6: */
	...
	*(*Subtree)(unsafe.Pointer(bp)) = self
	...
	libc.Xfprintf(tls, f, ts+5024 /* "digraph tree {\n" */, 0)
	libc.Xfprintf(tls, f, ts+3899 /* "edge [arrowhead=..." */, 0)
...
func ts_tree_cursor_iterate_children(tls *libc.TLS, self uintptr) CursorChildIterator { /* tree_cursor.c:18:35: */
	var last_entry uintptr = func() uintptr {
		if ((*struct {
			...
			Size     Uint32_t
			Capacity Uint32_t
		})(unsafe.Pointer((self + 8 /* &.stack */))).Size {
		} else {
			libc.X__assert_fail(tls, ts+746 /* "(uint32_t)(&self..." */, ts+5040 /* "/tmp/tmp.Q5CoXz9..." */, uint32(19), uintptr(unsafe.Pointer(&__func__116)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__116 = *(*[32]int8)(unsafe.Pointer(ts + 5094 /* "ts_tree_cursor_i..." */)) /* tree_cursor.c:18:91 */
...
func Xts_tree_cursor_current_node(tls *libc.TLS, _self uintptr) TSNode { /* tree_cursor.c:260:8: */
	...
	var last_entry uintptr = func() uintptr {
		if ((*struct {
			...
			libc.X__assert_fail(tls, ts+746 /* "(uint32_t)(&self..." */, ts+5040 /* "/tmp/tmp.Q5CoXz9..." */, uint32(262), uintptr(unsafe.Pointer(&__func__117)))
		}
		return ((*struct {
			Contents uintptr
			Size     Uint32_t
...
var __func__117 = *(*[28]int8)(unsafe.Pointer(ts + 5126 /* "ts_tree_cursor_c..." */)) /* tree_cursor.c:260:63 */
...
func Xts_tree_new(tls *libc.TLS, root Subtree, language uintptr, included_ranges uintptr, included_range_count uint32) uintptr { /* tree.c:8:8: */
	...
	libc.Xmemcpy(tls, (*TSTree)(unsafe.Pointer(result)).Included_ranges, included_ranges, (uint64(included_range_count) * uint64(unsafe.Sizeof(TSRange{}))))
